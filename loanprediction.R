...
library(ggplot2)
library(rpart)
setwd("Z:/Courses/R docs/")
train <- read.csv("train.csv",na.strings = c("","NaN"," "))
test <- read.csv("test.csv",na.strings = c("","NaN"," "))
...
write.csv(submit,"Z:/Courses/R docs/1405_sub_1.csv",row.names = FALSE)
